...
export default function Qoute() {
  return (
    <div className="relative">
      ...
      <div className="px-[4.8rem] md:px-[2rem] py-36 flex flex-col gap-8">
        <div className="flex flex-col gap-16">
          <h3 className="font-mont-bold text-4xl ">
            They’re consistent, and the
            <br className="block md:hidden" /> communication is good.
          </h3>
          <p className="text-secondary">
            When I have a deadline, they would work extra hours on the weekend
            and after
            <br className="block md:hidden" /> hours. Cinnamon gives the
        ...
        <div className="flex md:flex-col md:gap-10 justify-between">
          <Direction className="gap-12" />
          <View>VIEW CASE STUDY</View>
        </div>
        <div className="absolute block md:hidden top-1/4 right-[4.8rem]">
          <Image
